...
//                tv.setText("加载完成");
        ...
        sAdapter = new SAdapter(objects)
                .addType(new BaseHolder<aa>(R.layout.footer) {
                    ...
                    @Override
                    public int gridSpanSize(aa item, int position) {
                        return 1;
                    }
                })
                ...
                .addType(new BaseHolder<cc>(R.layout.footer) {
                    ...
                    @Override
                    public int gridSpanSize(cc item, int position) {
                        return 1;
                    }
                    @Override
...
//        recyclerView1.setLayoutManager(new LinearLayoutManager(this));
        ...
        new RefreshAdapterHandler().attachRefreshLayout(layout, sAdapter, new GridLayoutManager(this,2));
    }
