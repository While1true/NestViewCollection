    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       adapter = new SBaseMutilAdapter<String, String>(list)
        ...
        recyclerView.addDefaultHeaderFooter()
                ...
                .setAdapter(new StaggeredGridLayoutManager(5,StaggeredGridLayoutManager.VERTICAL), adapter)
                .setRefreshingListener(new SRecyclerView.OnRefreshListener() {
                    ...
                    public void PreLoading() {
                        super.PreLoading();
                        Toast.makeText(StaggedLayoutManager.this, "滑倒底部，正在预加载", Toast.LENGTH_LONG).show();
                        recyclerView.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                recyclerView.notifyRefreshComplete();
